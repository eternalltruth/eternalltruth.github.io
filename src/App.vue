...
<template>
  <div class="main-container" v-if="!loading">
    <div class="useful-link no-print">
      ...
      <a class="github-button" href="https://github.com/eternalltruth/eternalltruth.github.io" title="查看源码">
        ...
        <header class="header">
          <div class="header-box">
            <div class="avatar wow inShow no-print">
              <img src="../public/img/logo.jpeg" alt="logo" class="img-responsive">
            </div>
